...
EXP_RULES = mk_rules(parse_exp_INT,[([lexer.VAR], parse_exp_VAR), ([lexer.PLUS], parse_exp_PLUS),([lexer.MINUS], parse_exp_MINUS), ([lexer.MULT], parse_exp_MULT),([lexer.DIV], parse_exp_DIV)])
