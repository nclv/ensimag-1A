...
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { B[1] }]; #IO_L24P_T3_34       Sch=SW1
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { B[2] }]; #IO_L4N_T0_34        Sch=SW2
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { B[3] }]; #IO_L9P_T1_DQS_34    Sch=SW3
...
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { B[4]  }]; #IO_L18P_T2_34  Sch=BTN2
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { B[5]  }]; #IO_L7P_T1_34   Sch=BTN3


# LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { aff[0] }]; #IO_L23P_T3_35          Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { aff[1] }]; #IO_L23N_T3_35          Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { aff[2] }]; #IO_0_35                Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { aff[3] }]; #IO_L3N_T0_DQS_AD1N_35  Sch=LED3
