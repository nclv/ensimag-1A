...
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { push[3] }]; #IO_L7P_T1_34   Sch=BTN3


# LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { s0 }]; #IO_L23P_T3_35          Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { s1 }]; #IO_L23N_T3_35          Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { s2 }]; #IO_0_35                Sch=LED2
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { s3 }]; #IO_L3N_T0_DQS_AD1N_35  Sch=LED3
